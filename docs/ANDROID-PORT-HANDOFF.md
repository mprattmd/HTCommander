...
#    NOTE: RepeaterBook now ships unconditionally (the RB_HIDDEN feature gate and
#    FeatureFlags.cs were removed once the feature was approved). No hide flag remains.
