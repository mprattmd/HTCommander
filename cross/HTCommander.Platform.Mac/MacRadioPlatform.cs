...
/// <summary>
/// macOS implementation of the <see cref="IRadioPlatform"/> factory seam: hands out
/// the IOBluetooth discovery + RFCOMM transport. Selected by the composition root
/// when <see cref="OperatingSystem.IsMacOS"/>.
/// </summary>
public sealed class MacRadioPlatform : IRadioPlatform
{
    public IRadioTransportDiscovery CreateDiscovery() => new MacRadioDiscovery();
