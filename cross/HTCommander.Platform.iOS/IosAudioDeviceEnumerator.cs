...
/// <summary>
/// iOS audio enumerator: reports no devices and hands out no-op playback/capture.
/// Voice (the radio's SBC stream) needs the Bluetooth-Classic RFCOMM audio channel,
/// which iOS does not expose — so there is nothing to render or capture. The shared
/// view-model code still calls this factory; voice features stay gated off. Mirrors
/// <c>AndroidAudioDeviceEnumerator</c>.
/// </summary>
public sealed class IosAudioDeviceEnumerator : IAudioDeviceEnumerator
{
